    ...
    return (
        <>
            <div className='container about-me'>
                <div className='about-me-title text-center fw-bold' data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1000">About Me</div>
                <div className='about-me-content' data-aos="zoom-in" data-aos-easing="linear" data-aos-duration="1600">
