...
function Nav() {
    ...
    return (
        ...
        <nav className={`${navDisplay} bg-${(theme==="white")?"black":"white"} text-${theme} shadow-lg shadow-${(theme==="white")?"blue-500":"red-600"} text-xl px-2 py-2 gap-1 md:text-2xl w-max fixed md:px-7 md:py-3.5 left-1/2 md:gap-3 bottom-8 -translate-x-1/2 rounded-3xl`}  id="navbar">
